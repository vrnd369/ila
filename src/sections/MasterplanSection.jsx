...
export default function MasterplanSection() {
  return (
    <>
      <h1 className="masterplanTitle">NATURE LEADS<br />the DESIGN</h1>
      
      <div className="masterplanSpaceContainer">
        <h2 className="masterplanSpaceTitle">SPACE MEASURED IN CALM<br />NOT JUST YARDS</h2>
      ...
      <div className="masterplanConvenienceContainer">
        <h2 className="masterplanConvenienceTitle">REDEFINING CONVENIENCE at MOINABAD</h2>
        ...
        <div className="masterplanMapsTravelContainer">
          ...
          <ul className="masterplanTravelList">
            <li className="masterplanTravelItem"><span className="masterplanTravelNumber">5</span> MINS <span className="travelFrom">from</span> PRAGATHI RESORTS</li>
            <li className="masterplanTravelItem"><span className="masterplanTravelNumber">10</span> MINS <span className="travelFrom">from</span> EXPERIAN</li>
            <li className="masterplanTravelItem"><span className="masterplanTravelNumber">10</span> MINS <span className="travelFrom">from</span> RENOWNED INTERNATIONAL SCHOOLS</li>
            <li className="masterplanTravelItem"><span className="masterplanTravelNumber">25</span> MINS <span className="travelFrom">from</span> THE FINANCIAL DISTRICT</li>
            <li className="masterplanTravelItem"><span className="masterplanTravelNumber">30</span> MINS <span className="travelFrom">from</span> IBS</li>
            <li className="masterplanTravelItem"><span className="masterplanTravelNumber">35</span> MINS <span className="travelFrom">from</span> THE INTERNATIONAL AIRPORT</li>
          </ul>
        </div>
